...
function enableButton(letter, capital, number, length, match) 
{
    ...
    var condition = (letter.classList.value == "valid" & capital.classList.value == "valid" & number.classList.value == "valid" & length.classList.value == "valid" & match.classList.value == "valid"); 
